...
deep_space:
	...
	system("COLOR 3");
		...
		printf("DEEP SPACE PROGRAM");
		
		printf("\n==============================================================================\n\n");
		
		printf("\n\n==============================================================================\n");
		
		printf("Modul Halaman 60 [Study Case]");
		
		printf("\n==============================================================================\n\n");
			
			Ranting_Pohon* akar = nullptr;
		
			    pemasukanNode(akar, 15); //15 adalah angka dari soal di modul hal 60
			    pemasukanNode(akar, 30); //30 adalah angka dari soal di modul hal 60
			    pemasukanNode(akar, 27); //27 adalah angka dari soal di modul hal 60
			    pemasukanNode(akar, 25); //25 adalah angka dari soal di modul hal 60
			    pemasukanNode(akar, 29); //29 adalah angka dari soal di modul hal 60
